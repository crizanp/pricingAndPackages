    ...
    <div className="w-full bg-white py-12 sm:py-16 md:py-20 lg:py-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex justify-center">
          <Link href="contact">
            <button
              className="cursor-pointer bg-black text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-medium text-lg sm:text-xl flex items-center transition-all hover:bg-gray-800 hover:shadow-lg group"
            >
